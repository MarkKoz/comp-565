...
using UITexture = UIManager.Texture;
...
public class CubeManager : MonoBehaviour
{
    ...
    private IReadOnlyDictionary<UITexture, Material> materials;
    ...
    private void Start()
    {
        ...
        materials = new Dictionary<UITexture, Material> {
            { UITexture.StoneBricks01, Resources.Load<Material>("Materials/stone_bricks01") },
            { UITexture.StoneBricks02, Resources.Load<Material>("Materials/stone_bricks02") },
            { UITexture.Metal01, Resources.Load<Material>("Materials/metal01") },
        };
    ...
    private bool IsColliding(Vector3 position)
    {
        ...
        return ui.primitive switch {
            ...
            PrimitiveType.Capsule => Physics.CheckCapsule(
                position + (Vector3.up / 2), position + (Vector3.down / 2), radius, layerMask
            ),
